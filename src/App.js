          ...
          <div className={AppStyle.nav}>
            {
              routes.map((item, index) => {
                ...
                return <div className={AppStyle.routeItem}
                key={item.path}
                  ...
                  style={currentIndex == index ?
                    ...
                    {}}
                ><span style={currentIndex == index ? { color: '#ffffff' } : {}}>{item.title}</span></div>
              })
            }
            <a href="#" className={AppStyle.routeItem}>商城</a>
            <a href="#" className={AppStyle.routeItem}>音乐人</a>
            <a href="#" className={AppStyle.routeItem}>下载客户端</a>
          </div>
          <div className={AppStyle.search}>
            <Input placeholder="音乐/用户/歌手"
